**ORACLE ENTERPRISE MANAGER 24 PLUS ORACLE DATABASE 19C SI FS ONE CDB SILENT MODE OL9.5**
...
###### BUILD VIRTUAL MACHINE ON VIRTUALIZER
    ...
    [root@exated ~]# virt-install --virt-type kvm --name ol9d --memory 4096 --vcpus 2 --os-variant ol9.5 --cdrom /root/Downloads/OracleLinux-R9-U5-x86_64-dvd.iso --network bridge=br0,model=virtio --disk path=/var/lib/libvirt/images/ol9d.qcow2,size=50
