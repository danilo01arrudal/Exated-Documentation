...
Funcionalidade principal:
  - O LIO transforma um servidor Linux em um servidor de armazenamento em rede.
  - Ele permite que esse servidor exponha dispositivos de armazenamento como "alvos" para outros computadores ("iniciadores") acessarem.*
