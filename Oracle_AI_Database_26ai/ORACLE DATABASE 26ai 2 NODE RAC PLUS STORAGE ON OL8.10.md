**ORACLE AI DATABASE 26ai 2 NODE RAC PLUS STORAGE ON OL8.10**
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( DISABLE FIREWALL )
    ...
    [root@ol826ain1 ~]# systemctl disable firewalld
    [root@ol826ain2 ~]# systemctl stop firewalld
    [root@ol826ain2 ~]# systemctl disable firewalld

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( SET HOSTNAME )

    [root@ol826ain1 ~]# hostnamectl set-hostname ol826ain1.appsdba.info
    [root@ol826ain2 ~]# hostnamectl set-hostname ol826ain2.appsdba.info

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CHANGE THE CLOCK SOURCE IN THE SYSTEM )

    [root@ol826ain1 ~]# cat /sys/devices/system/clocksource/clocksource0/current_clocksource
    kvm-clock
    [root@ol826ain1 ~]# cat /sys/devices/system/clocksource/clocksource0/available_clocksource
    kvm-clock tsc acpi_pm 
    [root@ol826ain1 ~]# echo "tsc" > /sys/devices/system/clocksource/clocksource0/current_clocksource
    tsc
    [root@ol826ain2 ~]# echo "tsc" >  /sys/devices/system/clocksource/clocksource0/current_clocksource
    tsc

###### SET ON /etc/fstab TMPFS PARTITION

    [root@ol826ain1 ~]# vi /etc/fstab
		tmpfs      				  /dev/shm        	  tmpfs   defaults,size=4G	0 0
 
	[root@ol826ain2 ~]# vi /etc/fstab
 		tmpfs      				  /dev/shm        	  tmpfs   defaults,size=4G	0 0
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CONFIGURE STATIC NETWORK NODE 1)
    ...
    [root@ol826ain1 ~]# nmcli con down 'enp1s0'; nmcli con up 'ens3'  
	[root@ol826ain1 ~]# ip addr show enp1s0
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CONFIGURE STATIC NETWORK NODE 2)
    ...
    [root@ol826ain2 ~]# nmcli con down 'enp1s0'; nmcli con up 'ens3'  
	[root@ol826ain2 ~]# ip addr show enp1s0
	2: enp1s0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
    link/ether 52:54:00:85:ab:d0 brd ff:ff:ff:ff:ff:ff
    altname enp1s0
    inet 192.168.18.121/24 brd 192.168.18.255 scope global noprefixroute ens3
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( DISABLE AVAHI )
    ...
    [root@ol826ain1 ~]# systemctl disable avahi-daemon.socket avahi-daemon.service 
    Removed "/etc/systemd/system/multi-user.target.wants/avahi-daemon.service".
    Removed "/etc/systemd/system/sockets.target.wants/avahi-daemon.socket".
    Removed "/etc/systemd/system/dbus-org.freedesktop.Avahi.service".
    [root@ol826ain1 ~]# systemctl mask avahi-daemon.socket avahi-daemon.service 
    ...
    [root@ol826ain1 ~]# systemctl stop avahi-daemon.socket avahi-daemon.service

    [root@ol826ain2 ~]# systemctl disable avahi-daemon.socket avahi-daemon.service
    Removed "/etc/systemd/system/multi-user.target.wants/avahi-daemon.service".
    Removed "/etc/systemd/system/dbus-org.freedesktop.Avahi.service".
    Removed "/etc/systemd/system/sockets.target.wants/avahi-daemon.socket".
    [root@ol826ain2 ~]# systemctl mask avahi-daemon.socket avahi-daemon.service 
    Created symlink /etc/systemd/system/avahi-daemon.socket → /dev/null.
    Created symlink /etc/systemd/system/avahi-daemon.service → /dev/null.
    [root@ol826ain2 ~]# systemctl stop avahi-daemon.socket avahi-daemon.service

### PRE REQUIREMENTS ORACLE ENVIRONMENT ( SELINUX )

    [root@ol826ain1 ~]# sed -i 's/SELINUX=enforcing/SELINUX=disabled/g' /etc/selinux/config
    [root@ol826ain2 ~]# sed -i 's/SELINUX=enforcing/SELINUX=disabled/g' /etc/selinux/config

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( PACKAGES )

    [root@ol826ain1 ~]# yum install -y oracle-ai-database-preinstall-26ai.x86_64
    [root@ol826ain2 ~]# yum install -y oracle-ai-database-preinstall-26ai.x86_64
    [root@ol826ain1 ~]# yum install -y https://yum.oracle.com/repo/OracleLinux/OL8/addons/x86_64/getPackage/oracleasm-support-3.1.1-4.el8.x86_64.rpm
    [root@ol826ain2 ~]# yum install -y https://yum.oracle.com/repo/OracleLinux/OL8/addons/x86_64/getPackage/oracleasm-support-3.1.1-4.el8.x86_64.rpm
    [root@ol826ain1 ~]# rpm -ivh oracleasmlib-3.1.1-1.el9.x86_64.rpm 
    [root@ol826ain2 ~]# rpm -ivh oracleasmlib-3.1.1-1.el9.x86_64.rpm 
    [root@ol826ain1 ~]# yum install -y chkconfig
    [root@ol826ain2 ~]# yum install -y chkconfig
    [root@ol826ain1 ~]# yum install -y iscsi-initiator-utils udisks2-iscsi 
    [root@ol826ain2 ~]# yum install -y iscsi-initiator-utils udisks2-iscsi 

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( PLUGGABLE AUTHENTICATION MODULES )

    [root@ol826ain1 ~]# echo "session         required        pam_limits.so" >> /etc/pam.d/su 
    [root@ol826ain1 ~]# echo "session         required        pam_unix.so" >> /etc/pam.d/su
    [root@ol826ain2 ~]# echo "session         required        pam_limits.so" >> /etc/pam.d/su 
    [root@ol826ain2 ~]# echo "session         required        pam_unix.so" >> /etc/pam.d/su 
    [root@ol826ain1 ~]# echo "session    required     pam_limits.so" >> /etc/pam.d/sshd
    [root@ol826ain1 ~]# echo "session    required     pam_unix.so" >> /etc/pam.d/sshd
    [root@ol826ain2 ~]# echo "session    required     pam_limits.so" >> /etc/pam.d/sshd
    [root@ol826ain2 ~]# echo "session    required     pam_unix.so" >> /etc/pam.d/sshd
    [root@ol826ain1 ~]# echo "session    required     pam_limits.so" >> /etc/pam.d/login
    [root@ol826ain1 ~]# echo "session    required     pam_unix.so" >> /etc/pam.d/login
    [root@ol826ain2 ~]# echo "session    required     pam_limits.so" >> /etc/pam.d/login
    [root@ol826ain2 ~]# echo "session    required     pam_unix.so" >> /etc/pam.d/login

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( SECURITY LIMITS )

    [root@ol826ain1 ~]# cat <<EOF >> /etc/security/limits.conf
	...
	# End of file
    EOF
    [root@ol826ain2 ~]# cat <<EOF >> /etc/security/limits.conf
	# oracle-ai-database-preinstall-26ai setting for nofile soft limit is 1024
	oracle		soft	nofile		1024
	grid		soft	nofile    	1024
	# oracle-ai-database-preinstall-26ai setting for nofile hard limit is 65536
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CREATE USERS )
    ...
    [root@ol826ain1 ~]# userdel oracle; rm -Rvf /home/oracle; rm -Rvf /var/mail/oracle 
    [root@ol826ain2 ~]# userdel oracle; rm -Rvf /home/oracle; rm -Rvf /var/mail/oracle 
    [root@ol826ain1 ~]# groupadd -g 54321 oinstall; groupadd -g 54322 dba; groupadd -g 54323 oper; groupadd -g 54324 backupdba; groupadd -g 54325 dgdba; groupadd -g 54326 kmdba; groupadd -g 54327 asmdba; groupadd -g 54328 asmoper; groupadd -g 54329 asmadmin; groupadd -g 54330 racdba; useradd -m -u 54331 -g oinstall -G dba,oper,backupdba,dgdba,kmdba,asmdba,asmadmin,racdba -d /home/oracle -s /bin/bash  oracle; useradd -m -u 54332 -g oinstall -G dba,asmadmin,asmdba,asmoper -d /home/grid -s /bin/bash  grid; id oracle; id grid
    [root@ol826ain2 ~]# groupadd -g 54321 oinstall; groupadd -g 54322 dba; groupadd -g 54323 oper; groupadd -g 54324 backupdba; groupadd -g 54325 dgdba; groupadd -g 54326 kmdba; groupadd -g 54327 asmdba; groupadd -g 54328 asmoper; groupadd -g 54329 asmadmin; groupadd -g 54330 racdba; useradd -m -u 54331 -g oinstall -G dba,oper,backupdba,dgdba,kmdba,asmdba,asmadmin,racdba -d /home/oracle -s /bin/bash  oracle; useradd -m -u 54332 -g oinstall -G dba,asmadmin,asmdba,asmoper -d /home/grid -s /bin/bash  grid; id oracle; id grid
    [root@ol826ain1 ~]# passwd oracle
    [root@ol826ain2 ~]# passwd oracle
    [root@ol826ain1 ~]# passwd grid
    [root@ol826ain2 ~]# passwd grid

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CREATE DIRECTORIES )

    [root@ol826ain1 ~]# mkdir -p /u01/app/grid; mkdir -p /u01/app/23.26.1/grid; mkdir -p /u01/app/oracle; mkdir -p /u01/app/oracle/product/23.26.1/dbhome_1; chmod -R 775 /u01; chown -R grid:oinstall /u01; chown -R oracle:oinstall /u01/app/oracle; chown oracle:oinstall -R /home/oracle
    [root@ol826ain2 ~]# mkdir -p /u01/app/grid; mkdir -p /u01/app/23.26.1/grid; mkdir -p /u01/app/oracle; mkdir -p /u01/app/oracle/product/23.26.1/dbhome_1; chmod -R 775 /u01; chown -R grid:oinstall /u01; chown -R oracle:oinstall /u01/app/oracle; chown oracle:oinstall -R /home/oracle

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CONFIGURE /ETC/RESOLV.CONF )

    [root@ol826ain1 ~]# cat <<EOF > /etc/resolv.conf
    nameserver 192.168.18.43
    search appsdba.info
    EOF
    [root@ol826ain1 ~]# chattr +i /etc/resolv.conf
    [root@ol826ain2 ~]# cat <<EOF > /etc/resolv.conf
    nameserver 192.168.18.43
    search appsdba.info
    EOF
    [root@ol826ain2 ~]# chattr +i /etc/resolv.conf

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( ENVIRONMENT VARIABLES NODE 1 )

    [root@ol826ain1 ~]# cat <<EOF > /home/grid/.bash_profile 
    # .bash_profile
    ...
    export PATH
    EOF
    [root@ol826ain1 ~]# chown grid:oinstall /home/grid/.bash_profile
    [root@ol826ain1 ~]# cat <<EOF > /home/oracle/.bash_profile
    # .bash_profile
    ...
    export PATH
    EOF
    [root@ol826ain1 ~]# chown oracle:oinstall /home/oracle/.bash_profile
    [root@ol826ain1 ~]# cat <<EOF > /root/.bash_profile 
    # .bash_profile
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( ENVIRONMENT VARIABLES NODE 2 )
    ...
    [root@ol826ain2 ~]# cat <<EOF > /home/grid/.bash_profile 
    # .bash_profile
    ...
    export PATH
    EOF
    [root@ol826ain2 ~]# chown grid:oinstall /home/grid/.bash_profile
    [root@ol826ain2 ~]# cat <<EOF > /home/oracle/.bash_profile
    # .bash_profile
    ...
    export PATH
    EOF
    [root@ol826ain2 ~]# chown oracle:oinstall /home/oracle/.bash_profile
    [root@ol826ain2 ~]# cat <<EOF > /root/.bash_profile 
    # .bash_profile
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CONFIGURE ORACLE ASM LIBRARY NODE 1 )
    ...
    [root@ol826ain1 ~]# source /root/.bash_profile
    [root@ol826ain1 ~]# oracleasm configure -i
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CONFIGURE ORACLE ASM LIBRARY NODE 2 )
    ...
    [root@ol826ain2 ~]# source /root/.bash_profile
    [root@ol826ain2 ~]# oracleasm configure -i
    Configuring the Oracle ASM library driver.
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( GET ISCSI ID )
    ...
    [root@ol826ain1 ~]# iscsiadm -m discovery -t sendtargets -p 192.168.18.46
	192.168.18.46:3260,1 iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968
	[root@ol826ain2 ~]# iscsiadm -m discovery -t sendtargets -p 192.168.18.46
	192.168.18.46:3260,1 iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968
	[root@ol826ain1 ~]# cat /etc/iscsi/initiatorname.iscsi
	InitiatorName=iqn.1994-05.com.redhat:a0bb1ac81cd4
	[root@ol826ain2 ~]# cat /etc/iscsi/initiatorname.iscsi
	InitiatorName=iqn.1994-05.com.redhat:a0822cd78296
    
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( LOGIN ISCSI )
    
	[root@ol826ain1 ~]# iscsiadm -m node -T iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968 -p 192.168.18.46 -l
	[root@ol826ain2 ~]# iscsiadm -m node -T iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968 -p 192.168.18.46 -l
    
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( AUTOMATIC LOGIN ISCSI )

	[root@ol826ain1 ~]# iscsiadm -m node -T iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968 -p 192.168.18.46 -o update -n node.startup -v automatic
	[root@ol826ain2 ~]# iscsiadm -m node -T iqn.2003-01.org.linux-iscsi.ol9scsi.x8664:sn.b4c74d69d968 -p 192.168.18.46 -o update -n node.startup -v automatic

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CHECK ISCSI DISKS )

	[root@ol826ain1 ~]# fdisk -l | grep "Disk /dev/sd"
	...
	[root@ol826ain2 ~]# fdisk -l | grep "Disk /dev/sd"
	Disk /dev/sda: 59 GiB, 63350767616 bytes, 123731968 sectors
	Disk /dev/sdb: 30 GiB, 32212254720 bytes, 62914560 sectors
	Disk /dev/sdc: 30 GiB, 32212254720 bytes, 62914560 sectors
	Disk /dev/sdd: 30 GiB, 32212254720 bytes, 62914560 sectors
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CREATE PARTITION ISCSI DISKS )
    ...
    [root@ol826ain1 ~]# fdisk /dev/sdb
    n > p > 1 > w
    [root@ol826ain1 ~]# fdisk /dev/sdc
    n > p > 1 > w
    [root@ol826ain1 ~]# fdisk /dev/sdd
    n > p > 1 > w
    [root@ol826ain1 ~]# fdisk /dev/sde
    n > p > 1 > w
    [root@ol826ain1 ~]# fdisk /dev/sdf
    n > p > 1 > w

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( GET ISCSI DISKS UUID )

	[root@ol826ain1 ~]# /usr/lib/udev/scsi_id -g -u -d /dev/sdb1 
	3600140530b1b516a4b546498ef061992
	[root@ol826ain1 ~]# /usr/lib/udev/scsi_id -g -u -d /dev/sdc1
	36001405f9da5bf8739e46bd9b78d941b
	[root@ol826ain1 ~]# /usr/lib/udev/scsi_id -g -u -d /dev/sdd1 
	36001405e56bcf503218482196cbd1ec3
	[root@ol826ain1 ~]# /usr/lib/udev/scsi_id -g -u -d /dev/sde1 
	36001405a758b88d83ec49fc81d5f21b3
	[root@ol826ain1 ~]# /usr/lib/udev/scsi_id -g -u -d /dev/sdf1
	360014054b4639dcf64b494abb68561b9

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CREATE ASM DEVICES RULES )

    [root@ol826ain1 ~]# cat <<EOF > /etc/udev/rules.d/99-oracle-asmdevices.rules
    ...
    EOF
    [root@ol826ain2 ~]# cat <<EOF > /etc/udev/rules.d/99-oracle-asmdevices.rules
	KERNEL=="sd?1", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/\$parent", RESULT=="3600140530b1b516a4b546498ef061992", SYMLINK+="asm-disk1", OWNER="grid", GROUP="asmdba", MODE="0660"
	KERNEL=="sd?1", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/\$parent", RESULT=="36001405f9da5bf8739e46bd9b78d941b", SYMLINK+="asm-disk2", OWNER="grid", GROUP="asmdba", MODE="0660"
	KERNEL=="sd?1", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/\$parent", RESULT=="36001405e56bcf503218482196cbd1ec3", SYMLINK+="asm-disk3", OWNER="grid", GROUP="asmdba", MODE="0660"
	KERNEL=="sd?1", SUBSYSTEM=="block", PROGRAM=="/usr/lib/udev/scsi_id -g -u -d /dev/\$parent", RESULT=="36001405a758b88d83ec49fc81d5f21b3", SYMLINK+="asm-disk4", OWNER="grid", GROUP="asmdba", MODE="0660"
    ...
    [root@ol826ain1 ~]# udevadm test /block/sdb/sdb1
    [root@ol826ain1 ~]# udevadm test /block/sdc/sdc1
    [root@ol826ain1 ~]# udevadm test /block/sdd/sdd1
    [root@ol826ain1 ~]# udevadm test /block/sde/sde1
    [root@ol826ain1 ~]# udevadm test /block/sdf/sdf1
    [root@ol826ain1 ~]# udevadm control --reload-rules
    [root@ol826ain1 ~]# /sbin/udevadm trigger
    [root@ol826ain2 ~]# udevadm test /block/sdb/sdb1
    [root@ol826ain2 ~]# udevadm test /block/sdc/sdc1
    [root@ol826ain2 ~]# udevadm test /block/sdd/sdd1
    [root@ol826ain2 ~]# udevadm test /block/sde/sde1
    [root@ol826ain2 ~]# udevadm test /block/sdf/sdf1
    [root@ol826ain2 ~]# udevadm control --reload-rules
    [root@ol826ain2 ~]# /sbin/udevadm trigger

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( CHECK ASM DEVICES RULES )

	[root@ol826ain1 ~]# ls -ltr /dev/asm-disk*
	...
	[root@ol826ain2 ~]# ls -ltr /dev/asm-disk*
	lrwxrwxrwx 1 root root 4 Jan 31 15:52 /dev/asm-disk5 -> sdf1
	lrwxrwxrwx 1 root root 4 Jan 31 15:52 /dev/asm-disk3 -> sdd1
	lrwxrwxrwx 1 root root 4 Jan 31 15:52 /dev/asm-disk1 -> sdb1
	lrwxrwxrwx 1 root root 4 Jan 31 15:52 /dev/asm-disk4 -> sde1
...
###### SSH KEY EXCHANGE ( NODE 1 )
    ...
    [root@ol826ain1 ~]# su - root -c "ssh-keygen -t rsa"
    [root@ol826ain1 ~]# su - oracle -c "ssh-keygen -t rsa"
    [root@ol826ain1 ~]# su - grid -c "ssh-keygen -t rsa"
    [root@ol826ain1 ~]# su - root -c "cat /root/.ssh/id_rsa.pub > /root/.ssh/authorized_keys"
    [root@ol826ain1 ~]# su - oracle -c "cat /home/oracle/.ssh/id_rsa.pub > /home/oracle/.ssh/authorized_keys"
    [root@ol826ain1 ~]# su - grid -c "cat /home/grid/.ssh/id_rsa.pub > /home/grid/.ssh/authorized_keys"
    [root@ol826ain1 ~]# chmod 600 /root/.ssh/authorized_keys
    [root@ol826ain1 ~]# chmod 600 /home/oracle/.ssh/authorized_keys
    [root@ol826ain1 ~]# chmod 600 /home/grid/.ssh/authorized_keys
    [root@ol826ain1 ~]# ssh-copy-id -i .ssh/id_rsa.pub root@192.168.18.122
    [root@ol826ain1 ~]# su - oracle
    [oracle@ol826ain1 ~]$ ssh-copy-id -i .ssh/id_rsa.pub oracle@192.168.18.122
    [oracle@ol826ain1 ~]$ exit
    [root@ol826ain1 ~]# su - grid
    [grid@ol826ain1 ~]$ ssh-copy-id -i .ssh/id_rsa.pub grid@192.168.18.122
    [grid@ol826ain1 ~]$ exit
    
###### SSH KEY EXCHANGE ( NODE 2 )

    [root@ol826ain2 ~]# su - root -c "ssh-keygen -t rsa"
    [root@ol826ain2 ~]# su - oracle -c "ssh-keygen -t rsa"
    [root@ol826ain2 ~]# su - grid -c "ssh-keygen -t rsa"
    [root@ol826ain2 ~]# su - root -c "cat /root/.ssh/id_rsa.pub > /root/.ssh/authorized_keys"
    [root@ol826ain2 ~]# su - oracle -c "cat /home/oracle/.ssh/id_rsa.pub > /home/oracle/.ssh/authorized_keys"
    [root@ol826ain2 ~]# su - grid -c "cat /home/grid/.ssh/id_rsa.pub > /home/grid/.ssh/authorized_keys"
    [root@ol826ain2 ~]# chmod 600 /root/.ssh/authorized_keys
    [root@ol826ain2 ~]# chmod 600 /home/oracle/.ssh/authorized_keys
    [root@ol826ain2 ~]# chmod 600 /home/grid/.ssh/authorized_keys
    [root@ol826ain2 ~]# ssh-copy-id -i .ssh/id_rsa.pub root@192.168.18.121
    [root@ol826ain2 ~]# su - oracle
    [oracle@ol826ain2 ~]$ ssh-copy-id -i .ssh/id_rsa.pub oracle@192.168.18.121
    [oracle@ol826ain2 ~]$ exit
    [root@ol826ain2 ~]# su - grid
    [grid@ol826ain2 ~]$ ssh-copy-id -i .ssh/id_rsa.pub grid@192.168.18.121
    [grid@ol826ain2 ~]$ exit
...
###### UNZIP GRID INFRASTRUCTURE SOFTWARE
    ...
    [root@ol826ain1 ~]# su - grid
    [grid@ol826ain1 grid]$ cd /u01/app/23.26.1/grid/
    [grid@ol826ain1 grid]$ unzip V1054596-01.zip
    [grid@ol826ain1 grid]$ rm -vf V1054596-01.zip

###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( INSTALL CVU PACKAGE )

    [root@ol826ain1 ~]# rpm -ivh /u01/app/23.26.1/grid/cv/rpm/cvuqdisk-1.0.10-1.rpm 
    ...
    [root@ol826ain1 ~]# scp /u01/app/23.26.1/grid/cv/rpm/cvuqdisk-1.0.10-1.rpm root@ol826ain2:/root/
    [root@ol826ain1 ~]# ssh root@ol826ain2
    [root@ol826ain2 ~]# rpm -ivh cvuqdisk-1.0.10-1.rpm 
...
###### PRE REQUIREMENTS ORACLE ENVIRONMENT ( RUNCLUVFY )
	...
	Performing following verification checks ...
	  ...
	  Group Membership: asmdba ...
	    ...
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         yes           yes           yes           passed          
	    ol826ain1         yes           yes           yes           passed          
	  ...
	  Group Membership: oinstall(Primary) ...
	    ...
	    ----------------  ------------  ------------  ------------  ------------  ------------
	    ol826ain2         yes           yes           yes           yes           passed      
	    ol826ain1         yes           yes           yes           yes           passed      
	  Group Membership: oinstall(Primary) ...PASSED
	  Run Level ...
	    Node Name     run level                 Required                  Status    
	    ------------  ------------------------  ------------------------  ----------
	    ol826ain2     5                         3,5                       passed    
	    ol826ain1     5                         3,5                       passed    
	  Run Level ...PASSED
	  Hard Limit: maximum open file descriptors ...
	    Node Name         Type          Available     Required      Status          
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         hard          65536         65536         passed          
	    ol826ain1         hard          65536         65536         passed          
	  Hard Limit: maximum open file descriptors ...PASSED
	  Soft Limit: maximum open file descriptors ...
	    Node Name         Type          Available     Required      Status          
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         soft          1024          1024          passed          
	    ol826ain1         soft          1024          1024          passed          
	  Soft Limit: maximum open file descriptors ...PASSED
	  Hard Limit: maximum user processes ...
	    Node Name         Type          Available     Required      Status          
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         hard          16384         16384         passed          
	    ol826ain1         hard          16384         16384         passed          
	  Hard Limit: maximum user processes ...PASSED
	  Soft Limit: maximum user processes ...
	    Node Name         Type          Available     Required      Status          
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         soft          16384         2047          passed          
	    ol826ain1         soft          16384         2047          passed          
	  Soft Limit: maximum user processes ...PASSED
	  Soft Limit: maximum stack size ...
	    Node Name         Type          Available     Required      Status          
	    ----------------  ------------  ------------  ------------  ----------------
	    ol826ain2         soft          10240         10240         passed          
	    ol826ain1         soft          10240         10240         passed          
	  Soft Limit: maximum stack size ...PASSED
	  Architecture ...
	    Node Name     Available                 Required                  Status    
	    ------------  ------------------------  ------------------------  ----------
	    ol826ain2     x86_64                    x86_64                    passed    
	    ol826ain1     x86_64                    x86_64                    passed    
	  Architecture ...PASSED
	  OS Kernel Version ...
	    Node Name     Available                 Required                  Status    
	    ------------  ------------------------  ------------------------  ----------
...
###### CHANGE CV_ASSUME_DISTID PARAMETER 
    ...
    [root@ol826ain1 ~]# vi /u01/app/23.26.1/grid/cv/admin/cvu_config
...
###### INSTALL GRID 26AI 
	...
	[grid@ol826ain1 ~]$ /u01/app/23.26.1/grid/gridSetup.sh
...
###### INSTALL GRID 26AI RUN CONFIGURATION SCRIPTS {orainstRoot.sh} NODE 2
	...
	[root@ol826ain2 ~]# /u01/app/oraInventory/orainstRoot.sh
	Changing permissions of /u01/app/oraInventory.
	Adding read,write permissions for group.
	Removing read,write,execute permissions for world.
...
###### INSTALL GRID 26AI RUN CONFIGURATION SCRIPTS {root.sh} NODE 1
	...
	[root@ol826ain1 ~]# /u01/app/23.26.1/grid/root.sh
	...
	The log of current session can be found at:
	  /u01/app/grid/crsdata/ol826ain1/crsconfig/rootcrs_ol826ain1_2026-02-05_08-14-46PM.log
...
###### INSTALL GRID 26AI RUN CONFIGURATION SCRIPTS {root.sh} NODE 2
	...
	[root@ol826ain2 ~]# /u01/app/23.26.1/grid/root.sh 
	Performing root user operation.
	...
	Using configuration parameter file: /u01/app/23.26.1/grid/crs/install/crsconfig_params
	The log of current session can be found at:
	  /u01/app/grid/crsdata/ol826ain2/crsconfig/rootcrs_ol826ain2_2026-02-05_08-17-12PM.log
...
###### POST INSTALL CHECK ENVIRONMENT ( RUNCLUVFY )
    ...
    Informações de interface para o nó "ol826ain1"
    ...
    ol826ain1             enp1s0        192.168.18.185  192.168.18.0  1500                      
    ol826ain1             enp1s0        192.168.18.184  192.168.18.0  1500            
    ol826ain1             enp1s0        192.168.18.187  192.168.18.0  1500            
    ol826ain2             enp1s0        192.168.18.122  192.168.18.0  1500                     
    ol826ain2             enp1s0        192.168.18.186  192.168.18.0  1500            

    Origem                      Destino                     Conectado?                
    --------------------------  --------------------------  --------------------------
    ol826ain1[enp1s0:192.168.18.121]  ol826ain2[enp1s0:192.168.18.122]  sim                                            
    ol826ain1[enp1s0:192.168.18.121]  ol826ain2[enp1s0:192.168.18.186]  sim                       
    ol826ain1[enp1s0:192.168.18.185]  ol826ain2[enp1s0:192.168.18.122]  sim                                         
    ol826ain1[enp1s0:192.168.18.185]  ol826ain2[enp1s0:192.168.18.186]  sim                                           
    ol826ain1[enp1s0:192.168.18.184]  ol826ain2[enp1s0:192.168.18.122]  sim                                             
    ol826ain1[enp1s0:192.168.18.184]  ol826ain2[enp1s0:192.168.18.186]  sim                       
    ol826ain1[enp1s0:192.168.18.187]  ol826ain2[enp1s0:192.168.18.122]  sim                                           
    ol826ain1[enp1s0:192.168.18.187]  ol826ain2[enp1s0:192.168.18.186]  sim                       
    ...
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/metadata" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/lck" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/log" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/trace" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/cdump" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/metadata_pv" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/alert" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/sweep" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/stage" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/metadata_dgif" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/incpkg" ...APROVADO
    Path "/u01/app/grid/diag/crs/ol826ain1/crs/incident" ...APROVADO
    ...
    Nome do Nó                            Status                  
    ------------------------------------  ------------------------
    ol826ain1                                 em execução             
    ol826ain2                                 em execução             
    Integridade de Gerenciador de Cluster ...APROVADO
    Máscara do Usuário ...
    Nome do Nó    Disponível                Necessário                Comentário
    ------------  ------------------------  ------------------------  ----------
    ol826ain2         0022                      0022                      aprovado  
    ol826ain1         0022                      0022                      aprovado  
    ...
    ------------  ------------------------  ------------------------  ----------
    ol826ain1         sim                       sim                       aprovado  
    ol826ain2         sim                       sim                       aprovado  
    ...
    Nome do Nó    Necessário                Em execução?              Comentário
    ------------  ------------------------  ------------------------  ----------
    ol826ain1         não                       sim                       aprovado  
    ol826ain2         não                       sim                       aprovado  
    ...
    ----------------  ------------  ------------  ------------  ------------  ------------
    ol9n-scan         ol826ain1         true          LISTENER_SCAN1  1521          true        
    ol9n-scan         ol826ain1         true          LISTENER_SCAN2  1521          true        
    ol9n-scan         ol826ain1         true          LISTENER_SCAN3  1521          true        
    ol9n-scan         ol826ain2         true          LISTENER_SCAN4  1521          true        

    Verificando a conectividade TCP com os listeners SCAN...

    Nó            ListenerName              Conectividade do TCP?   
    ------------  ------------------------  ------------------------
    ol826ain1         LISTENER_SCAN1            sim                     
    ol826ain1         LISTENER_SCAN2            sim                     
    ol826ain1         LISTENER_SCAN3            sim                     
    ol826ain1         LISTENER_SCAN4            sim                     
    ...
    ------------  ------------------------  ------------------------
    ol826ain2         aprovado                  não existe              
    ol826ain1         aprovado                  não existe              
    ...
    ------------  ------------------------  ------------------------  ----------
    ol826ain2         psmisc-23.4-3.el9         psmisc-22.6-19            aprovado  
    ol826ain1         psmisc-23.4-3.el9         psmisc-22.6-19            aprovado  
...
###### CHECK POST DATABASE CREATION
    ...
    [oracle@ol826ain1 ~]$ ps -ef | grep pmon
...
###### STOP CLUSTER AND DATABASE 
	...
	[root@ol826ain1 ~]# crsctl stop cluster -all
	CRS-2673: Tentativa de interromper 'ora.crsd' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.crsd' em 'ol826ain2'
	CRS-2790: Iniciando o shutdown de recursos gerenciados pelo Cluster Ready Services no servidor 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.chad' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.oradbc.oradbc_pdboradbc.svc' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.cdp4.cdp' em 'ol826ain2'
	CRS-2790: Iniciando o shutdown de recursos gerenciados pelo Cluster Ready Services no servidor 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.cdp1.cdp' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.cdp2.cdp' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.oradbc.oradbc_pdboradbc.svc' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.cdp3.cdp' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.chad' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.cdp4.cdp' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.oradbc.oradbc_pdboradbc.svc' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.oradbc.pdboradbc.pdb' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.cdp1.cdp' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.cdp2.cdp' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.oradbc.pdboradbc.pdb' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.cdp3.cdp' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.oradbc.db' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.oradbc.oradbc_pdboradbc.svc' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.oradbc.pdboradbc.pdb' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.oradbc.pdboradbc.pdb' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.oradbc.db' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.oradbc.db' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.LISTENER.lsnr' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.LISTENER_SCAN4.lsnr' em 'ol826ain2'
	CRS-33673: Tentando interromper o grupo de recursos 'ora.asmgroup' no servidor 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.DATA.dg' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.FRA.dg' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.DATA.dg' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.FRA.dg' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asm' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.asm' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.ASMNET1LSNR_ASM.lsnr' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.LISTENER.lsnr' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.LISTENER_SCAN4.lsnr' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.ol826ain2.vip' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.scan4.vip' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.ol826ain2.vip' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.ASMNET1LSNR_ASM.lsnr' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asmnet1.asmnetwork' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.asmnet1.asmnetwork' em 'ol826ain2' bem-sucedida
	CRS-33677: A interrupção do grupo de recursos 'ora.asmgroup' no servidor 'ol826ain2' foi bem-sucedida.
	CRS-2677: Interrupção de 'ora.scan4.vip' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.oradbc.db' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.chad' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.LISTENER.lsnr' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.LISTENER_SCAN1.lsnr' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.LISTENER_SCAN2.lsnr' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.LISTENER_SCAN3.lsnr' em 'ol826ain1'
	CRS-33673: Tentando interromper o grupo de recursos 'ora.asmgroup' no servidor 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.DATA.dg' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.FRA.dg' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.cvu' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.ons' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.DATA.dg' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.chad' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.cvu' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.FRA.dg' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asm' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.asm' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.ASMNET1LSNR_ASM.lsnr' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.ons' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.net1.network' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.net1.network' em 'ol826ain2' bem-sucedida
	CRS-2792: O shut-down de recursos gerenciados pelo Cluster Ready Services em 'ol826ain2' foi concluído
	CRS-2677: Interrupção de 'ora.LISTENER.lsnr' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.ol826ain1.vip' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.LISTENER_SCAN3.lsnr' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.scan3.vip' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.LISTENER_SCAN1.lsnr' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.scan1.vip' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.LISTENER_SCAN2.lsnr' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.scan2.vip' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.ASMNET1LSNR_ASM.lsnr' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asmnet1.asmnetwork' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.asmnet1.asmnetwork' em 'ol826ain1' bem-sucedida
	CRS-33677: A interrupção do grupo de recursos 'ora.asmgroup' no servidor 'ol826ain1' foi bem-sucedida.
	CRS-2677: Interrupção de 'ora.ol826ain1.vip' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.scan3.vip' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.scan1.vip' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.scan2.vip' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.ons' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.crsd' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.evmd' em 'ol826ain2'
	CRS-2673: Tentativa de interromper 'ora.storage' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.storage' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asm' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.ons' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.net1.network' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.net1.network' em 'ol826ain1' bem-sucedida
	CRS-2792: O shut-down de recursos gerenciados pelo Cluster Ready Services em 'ol826ain1' foi concluído
	CRS-2677: Interrupção de 'ora.evmd' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.crsd' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.evmd' em 'ol826ain1'
	CRS-2673: Tentativa de interromper 'ora.storage' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.storage' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.asm' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.evmd' em 'ol826ain1' bem-sucedida
	CRS-2677: Interrupção de 'ora.asm' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.cluster_interconnect.haip' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.cluster_interconnect.haip' em 'ol826ain2' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.cssd' em 'ol826ain2'
	CRS-2677: Interrupção de 'ora.asm' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.cluster_interconnect.haip' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.cssd' em 'ol826ain2' bem-sucedida
	CRS-2677: Interrupção de 'ora.cluster_interconnect.haip' em 'ol826ain1' bem-sucedida
	CRS-2673: Tentativa de interromper 'ora.cssd' em 'ol826ain1'
	CRS-2677: Interrupção de 'ora.cssd' em 'ol826ain1' bem-sucedida

	[root@ol826ain1 ~]# crsctl stop has
	CRS-2791: Starting shutdown of Oracle High Availability Services-managed resources on 'ol826ain1'
	CRS-2673: Attempting to stop 'ora.gpnpd' on 'ol826ain1'
	CRS-2673: Attempting to stop 'ora.crf' on 'ol826ain1'
	CRS-2673: Attempting to stop 'ora.mdnsd' on 'ol826ain1'
	CRS-2673: Attempting to stop 'ora.drivers.acfs' on 'ol826ain1'
	CRS-2677: Stop of 'ora.gpnpd' on 'ol826ain1' succeeded
	CRS-2677: Stop of 'ora.crf' on 'ol826ain1' succeeded
	CRS-2673: Attempting to stop 'ora.gipcd' on 'ol826ain1'
	CRS-2677: Stop of 'ora.gipcd' on 'ol826ain1' succeeded
	CRS-2677: Stop of 'ora.drivers.acfs' on 'ol826ain1' succeeded
	CRS-2677: Stop of 'ora.mdnsd' on 'ol826ain1' succeeded
	CRS-2793: Shutdown of Oracle High Availability Services-managed resources on 'ol826ain1' has completed
	CRS-4133: Oracle High Availability Services has been stopped.

	[root@ol826ain2 ~]# crsctl stop has
	CRS-2791: Starting shutdown of Oracle High Availability Services-managed resources on 'ol826ain2'
	CRS-2673: Attempting to stop 'ora.crf' on 'ol826ain2'
	CRS-2673: Attempting to stop 'ora.drivers.acfs' on 'ol826ain2'
	CRS-2673: Attempting to stop 'ora.gpnpd' on 'ol826ain2'
	CRS-2673: Attempting to stop 'ora.mdnsd' on 'ol826ain2'
	CRS-2677: Stop of 'ora.gpnpd' on 'ol826ain2' succeeded
	CRS-2677: Stop of 'ora.drivers.acfs' on 'ol826ain2' succeeded
	CRS-2677: Stop of 'ora.crf' on 'ol826ain2' succeeded
	CRS-2673: Attempting to stop 'ora.gipcd' on 'ol826ain2'
	CRS-2677: Stop of 'ora.gipcd' on 'ol826ain2' succeeded
	CRS-2677: Stop of 'ora.mdnsd' on 'ol826ain2' succeeded
	CRS-2793: Shutdown of Oracle High Availability Services-managed resources on 'ol826ain2' has completed
	CRS-4133: Oracle High Availability Services has been stopped.
