...
> *Note: For external tables or partitions , only the metadata and its definition form will be stored in the bank and the related data will be placed outside the database and at the operating system level.*
> *We want to enter information such as national code, name, surname and organizational code of people in a table called mytbl. With the following command, we partition this table based on the organizational code:,*
